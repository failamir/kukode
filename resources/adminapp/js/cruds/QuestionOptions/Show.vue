                    ...
                    <tbody>
                      <tr>
                        <td class="text-primary">
                          {{ $t('cruds.questionOption.fields.id') }}
                        </td>
                        <td>
                          {{ entry.id }}
                        </td>
                      ...
                      <tr>
                        <td class="text-primary">
                          {{ $t('cruds.questionOption.fields.is_correct') }}
                        </td>
                        <td>
...
export default {
  ...
  computed: {
    ...mapGetters('QuestionOptionsSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('QuestionOptionsSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
